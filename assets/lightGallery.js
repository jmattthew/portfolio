...
(function($) {
    ...
    $.fn.lightGallery = function(options) {
        ...
        var setUp = {
            ...
            structure: function() {
                $('body').append('<div id="lightGallery-outer" class="' + settings.addClass + '"><div id="lightGallery-Gallery"><div id="lightGallery-slider"></div><!-- TTT mod <a id="lightGallery-close" class="close"></a>--></div></div>').addClass('lightGallery');
